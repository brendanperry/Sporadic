...
class ActivityViewModelTests: XCTestCase {
    var viewModel = TestActivityViewModel()
    ...
    func testActivitiesAreAtDefaultValuesWhenNothingIsStoredOnDevice() throws {
        let initializedActivities = viewModel.getInitializeActivities()
        let loadedActivities = viewModel.getLoadedActivities(activities: initializedActivities)
